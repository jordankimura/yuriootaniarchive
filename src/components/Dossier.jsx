...
const formats = { app: 'Web app', taxonomy: 'Classification taxonomy', visual: 'Visual experiment', slides: 'Presentation', video: 'Moving image', writing: 'Short fiction', other: 'Concept / invitation' }
const actions = { app: 'Visit Yomi', taxonomy: 'Open the spreadsheet', visual: 'Explore the images', slides: 'Open the presentation', video: 'Watch the project', writing: 'Read the story', other: 'Open the invitation' }
